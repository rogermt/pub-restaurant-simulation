...
class TestSimulationRunner(unittest.TestCase):
    ...
    def test_run_multiple_simulations(self):
        ...
        num_runs = 3
        all_metrics = self.runner.run_multiple_simulations(num_runs=num_runs, verbose=False)
    ...
    def test_print_aggregate_results(self, mock_print):
        ...
        all_metrics = [
            {'total_customers_served': 10, 'customers_per_hour': 10.0, 'kitchen_utilization': 50.0, 'counter_utilization': 75.0},
            {'total_customers_served': 12, 'customers_per_hour': 12.0, 'kitchen_utilization': 60.0, 'counter_utilization': 80.0},
        ]
